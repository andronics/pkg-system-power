# power - AI Assistant Instructions
...
**Description**: Power Management - Battery, brightness, and power control

**Purpose**: Provide power management - battery, brightness, and power control functionality for the pkgs ecosystem.
...
**Executables**:
- `.local/bin/power` - Main executable
- `.local/bin/power.phase4.backup` - Main executable
...
1. **Test installation**: `stow power`
2. **Test functionality**: Run main commands and verify output
3. **Test uninstallation**: `stow -D power`
